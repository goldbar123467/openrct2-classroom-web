...
Choose **Restore backup**, select the Parkworks backup ZIP, and confirm. Every file is SHA-256 checked before existing local saves are changed. A corrupt or incorrect ZIP is rejected.

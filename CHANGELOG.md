...
- Added a pinned, clean source-to-WASM rebuild that validates the 512 MiB/2 GiB shared-memory contract and boots its freshly generated matching JS/WASM pair; tracked release hashes remain a separate gate.
